...
public record ExpenseDto(int Id, int PlanId, string Name, ExpenseCategory Category, decimal AnnualAmount, int StartYear, int? EndYear, decimal? GrowthRateOverridePct);
